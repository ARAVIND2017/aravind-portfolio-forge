...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 dark:from-slate-950 dark:via-blue-950 dark:to-slate-900 light:from-blue-50 light:via-white light:to-blue-100 text-white dark:text-white light:text-slate-900 overflow-x-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className={`transition-all duration-1000 mb-12 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="text-center mb-8">
              ...
              <p className="text-xl md:text-2xl mb-8 text-slate-300 dark:text-slate-300 light:text-slate-700 max-w-4xl mx-auto leading-relaxed">
                AI/ML Enthusiast | Full Stack Developer | App Builder | Hackathon Winner
              </p>
              <p className="text-lg mb-12 text-slate-400 dark:text-slate-400 light:text-slate-600 max-w-2xl mx-auto">
            ...
            {projects.map((project, index) => (
              <Card key={project.title} className="bg-slate-800/50 dark:bg-slate-800/50 light:bg-white/90 backdrop-blur-lg border-slate-700 dark:border-slate-700 light:border-slate-300 hover:border-blue-500/50 transition-all duration-300 transform hover-scale group shadow-lg light:shadow-xl">
                ...
                <CardContent>
                  ...
                  {project.award && (
                    <p className="text-yellow-400 dark:text-yellow-400 light:text-yellow-600 text-sm mb-4 font-medium">{project.award}</p>
                  )}
                  <div className="flex space-x-3">
                    <Button size="sm" variant="outline" className="border-slate-600 dark:border-slate-600 light:border-slate-400 hover:border-blue-500 hover-scale">
      ...
      <section id="achievements" className="py-20 bg-slate-900/50 dark:bg-slate-900/50 light:bg-slate-50/50">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-16 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
            Achievements
          </h2>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 bg-slate-900/50 dark:bg-slate-900/50 light:bg-slate-50/50">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-16 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
            Let's Connect
          </h2>
              ...
              <CardContent className="p-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <Input
                      ...
                      className="bg-slate-700/50 dark:bg-slate-700/50 light:bg-slate-50 border-slate-600 dark:border-slate-600 light:border-slate-300 text-white dark:text-white light:text-slate-900 placeholder-slate-400 dark:placeholder-slate-400 light:placeholder-slate-500 hover-scale"
                      required
                  ...
                  <div>
                    <Textarea
                      ...
                      className="bg-slate-700/50 dark:bg-slate-700/50 light:bg-slate-50 border-slate-600 dark:border-slate-600 light:border-slate-300 text-white dark:text-white light:text-slate-900 placeholder-slate-400 dark:placeholder-slate-400 light:placeholder-slate-500 min-h-[120px] hover-scale"
                      required
                      disabled={isSubmitting}
                    />
                  </div>
                ...
                <div className="mt-8 pt-8 border-t border-slate-700 dark:border-slate-700 light:border-slate-300">
                  <div className="flex justify-center space-x-6">
                    <a href="mailto:baravind196@gmail.com" className="flex items-center text-slate-300 dark:text-slate-300 light:text-slate-600 hover:text-blue-400 transition-colors hover-scale story-link">
                      <Mail className="h-5 w-5 mr-2" />
                      baravind196@gmail.com
                    </a>
                  </div>
                  <div className="flex justify-center space-x-6 mt-4">
                    <a href="https://linkedin.com/in/aravind2107" target="_blank" rel="noopener noreferrer" className="text-slate-300 dark:text-slate-300 light:text-slate-600 hover:text-blue-400 transition-colors hover-scale">
                      <Linkedin className="h-6 w-6" />
                    </a>
                    <a href="https://github.com/ARAVIND2017" target="_blank" rel="noopener noreferrer" className="text-slate-300 dark:text-slate-300 light:text-slate-600 hover:text-blue-400 transition-colors hover-scale">
      ...
      {/* Footer */}
      <footer className="bg-slate-950 dark:bg-slate-950 light:bg-white py-8 border-t border-slate-800 dark:border-slate-800 light:border-slate-200">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-slate-500 dark:text-slate-500 light:text-slate-500 text-sm">
